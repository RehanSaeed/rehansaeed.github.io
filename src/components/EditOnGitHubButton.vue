<template>
  <EffectLink button class="post__edit" :to="url">
    <svg aria-hidden="true" focusable="false" height="14" width="14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
      <title>GitHub</title>
