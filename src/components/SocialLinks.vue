<template>
  <div class="social">
    <EffectLink class="social__link" to="https://twitter.com/RehanSaeedUK">
      <svg aria-hidden="true" focusable="false" height="30" width="30" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <title>Twitter</title>
    ...
    <EffectLink class="social__link" to="https://github.com/RehanSaeed">
      <svg aria-hidden="true" focusable="false" height="30" width="30" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        <title>GitHub</title>
    ...
    <EffectLink class="social__link" to="https://stackoverflow.com/users/1212017/muhammad-rehan-saeed">
      <svg aria-hidden="true" focusable="false" height="30" width="30" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
